export default {
  ...
  HOME_SIDE_NAV_REQUESTS_DESC: 'مدیریت درخواست های مشتریان',
  HOME_SIDE_NAV_QUOTES: 'پیشنهادات',
  HOME_SIDE_NAV_QUOTES_DESC: 'مدیریت پیشنهادات همکاران',
  ...
  HOME_SIDE_NAV_PARTNERS: 'همکاران',
  HOME_SIDE_NAV_PARTNERS_DESC: 'تعریف و مدیریت همکاران تجاری',
  HOME_SIDE_NAV_CUSTOMERS: 'مشتریان',
  HOME_SIDE_NAV_CUSTOMERS_DESC: 'اطلاعات مشتریان',
  // PROFILE
  ...
  CONTENT_TYPE_MODAL_FOOTER_UPSERT_BTN_NEW: 'ایجاد قالب',
  ...
  CONTENT_TYPE_MODEL_HEADER_DESC: 'مشخصات قالب فرم انتخاب شده',
  CONTENT_TYPE_MODEL_SETTINGS_BTN: 'تنظیمات',
  CONTENT_TYPE_MODAL_HEADER_NEW: 'ایجاد قالب فرم جدید',
  CONTENT_TYPE_MODAL_NAME: 'نام',
  CONTENT_TYPE_MODAL_NAME_PLACEHOLDER: 'نام قالب خود را وارد کنید',
  CONTENT_TYPE_MODAL_NAME_DESCRIPTION: 'سعی کنید اسم مربوط وارد کنید',
  CONTENT_TYPE_MODAL_DESCRIPTION: 'توضیحات',
  CONTENT_TYPE_MODAL_DESCRIPTION_PLACEHOLDER: 'توضیح کوتاه برای قالب وارد کنید',
  CONTENT_TYPE_MODAL_IMAGES_TITLE: 'تصویر',
  CONTENT_TYPE_MODAL_IMAGES_DESC: 'برای قالب خود یک نمایه انتخاب کنید',
  CONTENT_TYPE_MODAL_TEMPLATE_BTN: 'Templates',
  CONTENT_TYPE_ADD_TITLE: 'عنوان',
  CONTENT_TYPE_ADD_TITLE_PLACEHOLDER: 'عنوان قالب خود را وارد کنید',
  CONTENT_TYPE_ADD_TITLE_INFO: 'عنوان قالب برای نمایش کاربرد دارد',
  ...
  CONTENT_TYPE_ADD_FIELD_MODAL_DESCRIPTION: 'توضیحات',
  CONTENT_TYPE_ADD_FIELD_MODAL_DESCRIPTION_PLACEHOLDER: 'توضیح کوتاه وارد کنید',
  CONTENT_TYPE_ADD_FIELD_MODAL_DESCRIPTION_INFO: 'اختیاری',
  CONTENT_TYPE_ADD_FIELD_MODAL_CREATE_BTN: 'ایجاد',
  CONTENT_TYPE_ADD_FIELD_MODAL_CREATE_CONFIG_BTN: 'ایجاد و تنظیمات',
  CONTENT_TYPE_ADD_FIELD_MODAL_CHNAGE_FIELD_BTN: 'تغییر مشخصه',
  CONTENT_TYPE_ADD_FIELD_CHOOSEN: 'ایجاد',
  CONTENT_TYPE_REMOVE_ALERT_TITLE: 'حذف قالب',
  CONTENT_TYPE_REMOVE_ALERT_MESSAGE: 'برای حذف قالب مطمئن هستید؟',
